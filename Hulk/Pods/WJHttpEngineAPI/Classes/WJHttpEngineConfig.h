 ...
 */
@interface WJHttpEngineConfig : AbstractWJBusinessObject

AS_SINGLETON(WJHttpEngineConfig)
...
/**
 *  HTTP 默认引擎名称
 *  ASIWJHttpEngine、AFWJHttpEngine
 *  default AFWJHttpEngine
 */
 ...
 *  default YES
 *  还可以在IWJHttpRequest 实现中实现方法 hideNetworkActivityIndicator 方法针对每个Request修改
 */
